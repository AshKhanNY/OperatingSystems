...
gcc -o multi multi.c -lm -lpthread
./multi
...
{
	printf("Executing multithreaded process...\n");
	...
	printf("Time taken to process with multiple threads: %f seconds\n", time_elapsed);
	return 0;
}
